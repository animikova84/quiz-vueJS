<template>
    <header>
        <section>
            <button>
                <a href="/"><span>Start quiz</span></a>
            </button>
            <section class="social-icons">
                <a href="https://www.facebook.com/photo.php?fbid=10210353293568970&set=a.2550870971354&type=3&theater" target="_blank">
                ...
                <a href="https://www.youtube.com/watch?v=zPonioDYnoY" target="_blank">
